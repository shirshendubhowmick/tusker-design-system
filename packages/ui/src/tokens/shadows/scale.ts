...
export interface ShadowModeValues {
...
export interface ShadowToken extends ShadowModeValues {
  name: string;
  description: string;
...
export const shadowTokens = {
  ...
  "xl": {
    ...
    cssVar: "--shadow-xl",
    description:
      "Highest elevation — rare full-screen takeovers, marketing moments",
    light:
  ...
  "top-sm": {
    ...
    description:
      "Default bottom sheet / mobile action bar separation from content above",
    light: "0 -1px 2px 0 rgb(0 0 0 / 0.06), 0 -1px 3px 0 rgb(0 0 0 / 0.1)",
    dark: "0 -1px 2px 0 rgb(0 0 0 / 0.95), 0 -4px 8px 0 rgb(0 0 0 / 0.8), 0 -8px 20px 0 rgb(0 0 0 / 0.7)",
  },
  "top-md": {
    ...
    description:
      "Elevated bottom sheet or docked panel floating over scrollable content",
    light:
  ...
  "border": {
    ...
    description:
      "1px outline via shadow (no layout shift; uses border-default color)",
